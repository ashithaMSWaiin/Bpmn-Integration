...
const RdsCompQuestions = (props: RdsCompQuestionsProps) => {
    ...
    return (
        <>
            ...
            <RdsCompFormsQuestions formQuestionsData={formQuestionsData1} handleQuestions={(data: any) => handleGetQuestions(data)} deleteQuestion={(data: any) => { props.deleteQuestion(data); }} handleDelete={(data:any)=>{props.handleDelete(data)}}></RdsCompFormsQuestions>
        </>
    );
};
