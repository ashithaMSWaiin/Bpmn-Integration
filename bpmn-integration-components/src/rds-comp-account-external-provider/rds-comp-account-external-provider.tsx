                ...
                {externalProvider.length !== 0 && (externalProvider.map((item: any, index: number) => (
                    <div className={` ${index == 0 ? "pt-3" : ""}`} key={index}>
                        <div className="fw-medium mb-3">
                            <RdsLabel label={t(item?.name) || ""} ></RdsLabel>
                        </div>
                        <div className="row">
                            <div className="col-md-12 mb-3">
                                <RdsCheckbox
                                    label={t("AbpAccount.ExternalProviderEnabled") || ""}
                            ...
                            <div className="row">
                                <div className="col-xxl-4 col-xl-4 col-lg-8 col-12 identityInput mb-3">
                                    <div className="form-group">
                                        <RdsInput
                                            value={item?.properties[0]?.value || ""}
                                            label={t("abp_react_8_1.ExternalProvider:Google:ClientId") || ""}
                                            placeholder=""
                                ...
                                <div className="col-xxl-4 col-xl-4 col-lg-8 col-12 identityInput mb-3">
                                    <div className="form-group">
                                        <RdsInput
                                            ...
                                            label={t("abp_react_8_1.ExternalProvider:Google:ClientSecret") || ""}
                                            placeholder=""
                                            customClasses="form-control"
                                            inputType="password"
