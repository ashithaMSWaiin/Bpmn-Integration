...
import { RdsIcon, RdsButton, RdsButtonGroup } from "../rds-elements";
                    ...
                    <div className="d-flex">
                      <div className="node_dot">
                        <div
                          className={`${
                            node
                              ? `${node?.level === 1 ? " " : "horizontal"}`
                              : ""
                          }`}
                        ></div>
                        {isLastParentNode && <div className="verticall"></div>}
                        {node?.level > 2 && isLastChild && isLastParentNode && (
                          <div className="vertical_not"></div>
                        )}
                      </div>
                      <div className="d-flex">
                        ...
                        <span className="ms-2 node-label d-flex">
                          ...
                          <span className=" node-icon1 btn-group-size pb-0 ">
                            <RdsButtonGroup
                              ...
                              vertical={false}
                              onButtonClick={(e, id) =>
                                handlerButtonGroupClick(e, id, node)
                              }
                            />
                          </span>
                        </span>
                        ...
                        {mobileList.map((button, index) => (
                          ...
                          >
                            <a
                              ...
                              onClick={(e) =>
                                handlerButtonGroupClickdrop(e, button.id, node)
                              }
                            >
                              {button.label}
                            </a>{" "}
                ...
                <div className="leftSpace">
                  {hasChildren && (
                    <div key={node.data.id} className="unitName">
                      <div className="position-relative mb-0 list-style ps-0">
  ...
  return (
    <>
      <ul className="position-relative mb-0 list-style ps-0">
        ...
        {props.organizationTreeData?.length !== 0 && <div></div>}
      </ul>
