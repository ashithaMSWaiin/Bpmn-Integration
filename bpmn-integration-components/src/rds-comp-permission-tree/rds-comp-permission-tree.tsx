...
const RdsCompPermissionTree = (props: RdsCompPermissionTreeProps) => {
  ...
  function modifiedPermissionData() {
    return props.permissions?.map((parent, parentIndex) => {
      const mainParentChildren =
        props.permissions[parentIndex].permissions ?? [];
  ...
  function handlerSelectAllCheckbox(event: any) {
      ...
      <div className="checkedstyle dottedstyle pb-5 pt-3">
        <div className="position-relative">
          ...
          <RdsCheckbox
            label={"Select All"}
            checked={selectAll}
            onChange={(e) => handlerSelectAllCheckbox(e.target.checked)}
          ...
          {treeData?.map((mainParent: any, mainParentIndex: any) => (
            <div
              ...
              key={mainParent.displayName + mainParentIndex}
            >
              ...
              <div className="position-relative pt-4">
                <RdsCheckbox
                  ...
                  state={
                    mainParent.isIntermediate ? "Indeterminate" : "Checkbox"
                  }
                  onChange={(e) =>
                    selectParentFn(
                      e.target.checked,
                ...
                <div className="ms-4 position-relative">
                  <div
                    className={
                      ...
                      `${
                        !showVerticalLine(parent, mainParentIndex)
                          ? "d-none"
                          : ""
                      }`
                    }
                    style={{
                      height: customHeightChild(parent, mainParentIndex),
                    }}
                  ></div>
                  <div
                    className={
                  ...
                  >
                    <RdsCheckbox
                      ...
                      state={
                        parent.isIntermediate ? "Indeterminate" : "Checkbox"
                      }
