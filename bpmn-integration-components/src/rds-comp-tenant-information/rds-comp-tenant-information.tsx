...
const RdsCompTenantInformation = (props: rdsCompTenantInformationProps) => {
  ...
  const handleDateChanges = (startDate: any) => {
    const originalDate = new Date(startDate);
    const formattedDateString = `${originalDate.getFullYear()}-${(
    ...
    setTenantInformationData({
      ...tenantInformationData,
      activationEndDate: formattedDateString,
    });
  };
      ...
      <div className="tab-content">
        <form>
            ...
            <div className="col-md-6">
              <div className="mb-3">
                <RdsSelectList
                  ...
                  onChange={(item: any) =>
                    handleDataChanges(item.value, "editionId")
                  }
                ></RdsSelectList>
              </div>
            </div>
          ...
          {!props.isEdit && (
            <>
              <div className="my-2">
                <label className="fw-bold" htmlFor="Admin details">
                  {t("Admin Details")}
                </label>
              </div>
              <div className="row">
                <div className="col-md-6 mb-2 cursor-pointer">
                  <div className="form-group">
                    <RdsInput
                      ...
                      validationMsg={
                        t("AbpValidation.ThisFieldIsNotAValidEmailAddress.") ||
                        ""
                      }
                    ></RdsInput>
                  </div>
                ...
                <>
                    ...
                    <div className="col-md-12 mb-3">
                      <div className="form-group">
                        <RdsTextArea
                          ...
                          rows={2}
                          value={
                            tenantInformationData?.connectionStrings?.default
                          }
                          dataTestId="data"
                        />
                      </div>
                  ...
                  <div className="row">
                    <div className="col-md-12 mb-3">
                      <RdsCheckbox
                        label={
                          t("Use Module Specific Database Connection String") ||
                          ""
                        }
            ...
            <div className="col-md-12">
              <div className="form-group text-capitalize mb-3">
                <RdsSelectList
                  ...
                  selectedValue={
                    tenantInformationData?.activationState?.toString() || ""
                  }
                  onChange={(item: any) =>
                    handleDataChanges(parseInt(item.value), "activationState")
                  }
                  required={true}
                ></RdsSelectList>
              </div>
          ...
          {tenantInformationData?.activationState == "1" && (
            <div className="row">
              <div className="col-md-12">
                <div className="form-group text-capitalize mb-3">
                  <RdsDatePicker
                    onDatePicker={handleDateChanges}
                    type="withTime"
          ...
          <div className="d-flex pb-3 pt-4 flex-column-reverse flex-lg-row flex-md-column-reverse flex-xl-row flex-xxl-row footer-buttons gap-2">
            <RdsButton
              class="me-2"
              tooltipTitle={""}
              type={"button"}
