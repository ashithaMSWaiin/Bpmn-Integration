...
import RdsCompEditionList from "../src/rds-comp-edition-list/rds-comp-edition-list";
    ...
    it("renders user table correctly", () => {
        render(
            <RdsCompEditionList
                ...
                } } onNewTenantClick={function (event: React.MouseEvent<HTMLButtonElement, MouseEvent>): void {
                    throw new Error("Function not implemented.");
                } }      />
        );
