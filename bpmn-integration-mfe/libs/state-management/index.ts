import authorityDelegationReducer from "./authoritydelegation/authoritydelegation-slice";
import linkedAccountsReducer from "./linkedaccounts/linkedaccounts-slice";
...
const rootReducer = combineReducers({
  authorityDelegation: authorityDelegationReducer,
