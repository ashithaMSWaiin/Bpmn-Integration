...
export const fetchScopesData = createAsyncThunk(
  "Scopes/fetchScopesData",
  (data: any) => {
    return ScopesService?.getScopes1({
      filter: undefined,
...
export const editScopesData = createAsyncThunk(
  "Scopes/editScopesData",
  (id: any) => {
...
export const deleteScopesData = createAsyncThunk(
  "Scopes/deleteScopesData",
  (id: any) => {
...
export const getScopesData = createAsyncThunk(
  "Scopes/getScopesData",
  (ScopeDto: any) => {
    return ScopesService?.postScopes({ requestBody: ScopeDto }).then(
      (result: any) => {
        return result;
      }
    );
...
export const updateScopesData = createAsyncThunk(
  "Scopes/updateScopesData",
  ({ id, updateScopeDto }: { id: any; updateScopeDto: any }) => {
    return ScopesService?.putScopes({
      id: id,
      requestBody: updateScopeDto,
    }).then((result: any) => {
      return result;
    });
  }
