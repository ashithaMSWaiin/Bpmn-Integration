...
import { System_Net_HttpStatusCode } from '../../proxy/index';

import { Volo_Abp_Application_Dtos_PagedResultDto_1 } from '../../proxy/index';

import { Volo_Abp_Auditing_EntityChangeType } from '../../proxy/index';

import { Volo_Abp_AuditLogging_AuditLogDto } from '../../proxy/index';

import { Volo_Abp_AuditLogging_EntityChangeDto } from '../../proxy/index';

import { Volo_Abp_AuditLogging_EntityChangeWithUsernameDto } from '../../proxy/index';

import { Volo_Abp_AuditLogging_GetAverageExecutionDurationPerDayOutput } from '../../proxy/index';

import { Volo_Abp_AuditLogging_GetErrorRateOutput } from '../../proxy/index';
