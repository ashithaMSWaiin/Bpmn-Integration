...
export const getBlogsBlogPosts1 = createAsyncThunk(
  "blogPost/getBlogsBlogPosts1",
  (id: any) => {
...
export const addBlogPostData = createAsyncThunk(
  ...
  (data: any) => {
    return BlogPostAdminService?.postBlogsBlogPostsCreateAndPublish({
      requestBody: data,
    }).then((result: any) => {
      return result.items;
    });
...
export const postBlogsPostsCreateAndSendToReview = createAsyncThunk(
  ...
  (data: any) => {
    return BlogPostAdminService?.postBlogsBlogPostsCreateAndSendToReview({
      requestBody: data,
    }).then((result: any) => {
      return result.items;
    });
...
export const postBlogPostsPublish = createAsyncThunk(
  ...
  ({ id }: { id: any }) => {
    return BlogPostAdminService?.postBlogsBlogPostsPublish({ id }).then(
      (result: any) => {
        return result;
      }
    );
...
export const postBlogPostsDraft = createAsyncThunk(
  ...
  ({ id }: { id: any }) => {
    return BlogPostAdminService?.postBlogsBlogPostsDraft({ id }).then(
      (result: any) => {
        return result;
      }
    );
...
export const deleteBlogPosts = createAsyncThunk(
  ...
  ({ id }: { id: any }) => {
    return BlogPostAdminService?.deleteBlogsBlogPosts({ id }).then(
      (result: any) => {
        return result;
      }
    );
