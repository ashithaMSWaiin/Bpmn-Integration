...
import { RdsButton, RdsInput, RdsOffcanvas } from "../../../../../bpmn-integration-elements/src";
...
it("Check payment Plans page behaviour", () => {
   ...
   const payment = render(
      <Provider store={store}>
        ...
        <RdsOffcanvas placement={"end"} backDrop={false} scrolling={false} offId={""} canvasTitle={"New Payment Plans"} onClose={handlerCloseOffcanvas}/>
        <RdsInput label="Name" placeholder="Enter Name" onChange={setPaymentPlansObj}/>
