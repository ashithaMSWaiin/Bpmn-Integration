...
import { RdsButton, RdsOffcanvas } from "../../../../../bpmn-integration-elements/src";
...
global.location = {
  ...
  jest.mock('../../../../libs/state-management/tenant/tenant-slice.ts', () => ({
    ...
    getTenantsLookupEditionsRequest: jest.fn().mockImplementation(() => Promise.resolve({})),
    getTenantsLookupEditions1Request: jest.fn().mockImplementation(() => Promise.resolve({})),
  }));
