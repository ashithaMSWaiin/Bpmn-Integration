...
import {
  deleteurlShortingData,
  editUrlShortingsData,
  fetchUrlShortingsData,
  saveUrlShortingData,
  updateUrlShortingData,
...
const UrlForwarding = () => {
  ...
  const [newUrlForwardingData, setNewUrlForwardingData] = useState({
    source: "",
    target: "",
  });
  ...
  const actions: any = [
    { id: "edit", displayName: t("AbpUi.Edit"), offId: "editUrlForwardingoff" },
    {
      ...
      modalId: "deleteUrlForwardingoff",
    },
  ];
  ...
  const handlerEditUrlForwardings = () => {
    dispatch(updateUrlShortingData({ id: id, body: editUrlData }) as any).then(
      (res: any) => {
  ...
  const onSortHandler = (col: any, key: string) => {
    console.log("Url Forwarding data-table -", col, key);
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="card px-4 py-4 border-0 rounded-0 card-full-stretch">
            <div className="row">
              <div className="offset-md-4 col-md-4 custom-responsive-alert">
                {Alert.show && (
                  <RdsAlert
              ...
              <div className="col-md-4 d-flex mb-3 justify-content-end">
                <RdsButton
                  icon="plus"
                  label={t("URL") || ""}
            ...
            >
              <div className="mt-2">
                <RdsCompUrlForwardings
                  urlForwardingData={newUrlForwardingData}
                  emitUrlForwardingData={getUrlForwardingsData}
                  reset={inputReset}
                />
                <div className="pb-3 d-flex flex-column-reverse flex-lg-row flex-md-column-reverse flex-xl-row flex-xxl-row flex-row footer-buttons gap-2">
                  ...
                  <RdsButton
                    ...
                    label={t("AbpUi.Save") || ""}
                    isDisabled={
                      newUrlForwardingData.source === "" &&
                      newUrlForwardingData.target === ""
                    }
                    colorVariant="primary"
            ...
            >
              <div className="mt-2">
                <RdsCompUrlForwardings
                  urlForwardingData={editUrlData}
                  emitUrlForwardingData={getUrlForwardingsDataForEdit}
                  isEdit={true}
                />
                <div className="pb-3 d-flex flex-column-reverse flex-lg-row flex-md-column-reverse flex-xl-row flex-xxl-row flex-row footer-buttons gap-2">
                  <RdsButton
