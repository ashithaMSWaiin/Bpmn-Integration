...
jest.mock('../../../../libs/state-management/applications/applications-slice.ts', () => ({
  ApplicationsService: {
    ...
    putApplications: jest.fn().mockResolvedValue({}),
    getApplications1: jest.fn().mockResolvedValue({}),
    postApplications: jest.fn().mockResolvedValue({}),
    deleteApplications: jest.fn().mockResolvedValue({}),
  },
 ...
 */
  test("renders Application page correctly", async () => {
  ...
  it('interacts with elements', async () => {
    ...
    const elements = render(
      <Provider store={store}>
        ...
        <RdsOffcanvas placement={"end"} backDrop={true} scrolling={true} offId={""} canvasTitle={"AbpOpenIddict.NewApplication"} />
