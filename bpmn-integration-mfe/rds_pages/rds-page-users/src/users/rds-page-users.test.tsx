...
jest.mock('../../../../libs/state-management/user/user-slice.ts', () => ({
  ...
  putUsersRequest: jest.fn(),
  deleteUsersRequest:jest.fn(),
  getUsers1Request: jest.fn(),
  postUsersRequest : jest.fn(),
  getUsersRolesRequest: jest.fn(),
  putUsersRolesRequest :jest.fn(),
  getUsersAvailableOrganizationUnitsRequest :jest.fn(),
  getUsersAssignableRolesRequest :jest.fn(),
