...
import RdsCompNewMenu from "../../../../../bpmn-integration-components/src/rds-comp-new-menu/rds-comp-new-menu";
...
jest.mock("../../../../../bpmn-integration-components/src/rds-comp-new-menu/rds-comp-new-menu", () => ({
  __esModule: true,
...
jest.mock("../../../../../bpmn-integration-components/src/rds-comp-alert-popup/rds-comp-alert-popup", () => ({
  __esModule: true,
