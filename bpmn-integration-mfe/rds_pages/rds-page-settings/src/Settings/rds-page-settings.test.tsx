...
import { RdsNavtabs } from "../../../../../bpmn-integration-elements/src";
...
global.location = {
  ...
  jest.mock('../../../../libs/state-management/settings/settings-slice.ts', () => ({
      ...
      fetchEmailSettings : jest.fn(),
      saveEmailSettings : jest.fn(),
      fetchIdentitySettings : jest.fn(),
      saveIdentitySettings : jest.fn(),
      fetchAccountSettings : jest.fn(),
      saveAccountSettings : jest.fn(),
      fetchExternalProviderSettings : jest.fn(),
      fetchFeaturesSettings : jest.fn(),
  }));
