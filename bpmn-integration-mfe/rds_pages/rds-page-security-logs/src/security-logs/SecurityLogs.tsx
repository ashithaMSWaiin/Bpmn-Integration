...
import {RdsButton, RdsInput, RdsDatePicker} from "../../../../../bpmn-integration-elements/src";
import {
    useAppDispatch,
    useAppSelector,
...
const SecurityLogs = () => {
    ...
    useEffect(() => {
        dispatch(fetchSecurityLogs({ skipCount: skipCount,sorting: sorting, maxResultCount: maxResultCount, startTime: formattedCurrentDate, endTime: formattedTomorrowDate }) as any);
    ...
    const onSortHandler = () => {
        ...
        setSorting((prevSorting) =>
          prevSorting === "id asc" ? "id desc" : "id asc"
        );
      };
