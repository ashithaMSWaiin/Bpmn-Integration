							...
							<div className="">
								<div className="d-flex align-items-center gap-3">
									...
									<div className="d-flex align-items-center gap-2">
										...
										<p className="fs-5 mb-0 landing__para">React</p>
									</div>
									<div>
								...
								<div className="fw-bold pt-3">
									<p className="banner-gradient fw-bolder mb-0"> AI powered, component-driven </p>
			...
			<div className="container-fluid py-5 mb-4">
				<div className="container">
					...
					<div className="align-items-center d-block d-lg-flex d-md-flex d-xl-flex d-xxl-flex gap-2 justify-content-center text-center">
						...
						<div>
							<a href="https://docs.raaghu.ai/" target="_blank" className="fs-5 text-primary text-decoration-underline">documentation.</a>
						</div>
					</div>
				</div>
			</div>
