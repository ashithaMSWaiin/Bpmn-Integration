...
global.location = {
  ...
  jest.mock('../../../../libs/state-management/tag-admin/tag-admin-slice.ts', () => ({ 
    postTagsRequest :jest.fn(),
    getTagsRequest :jest.fn(),
    deleteTagsRequest :jest.fn(),
    getTags1Request :jest.fn(),
    putTagsRequest :jest.fn(),
    getTagsTagDefinitionsRequest :jest.fn(),
  }));
