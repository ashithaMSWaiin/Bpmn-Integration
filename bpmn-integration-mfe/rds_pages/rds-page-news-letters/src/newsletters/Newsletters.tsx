...
const Newsletters = (props: RdsPageNewsLetterProps) => {
  ...
  const newsletters = useAppSelector(
    (state) => state.persistedReducer.newsletters
  );
  ...
  const onSortHandler = (col: any, key: string) => {
    console.log("Newsletter data-table -", col, key);
    ...
    <div className="card px-4 py-4 h-100 border-0 rounded-0 card-full-stretch">
      <div className="row align-items-center">
        {newsLettersData?.length > 0 && (
          <div className="col-md-6 col-xxl-3 col-xl-3 col-lg-6 col-12 mb-3">
            <RdsSearch
              label=""
              labelPosition="top"
              placeholder="Search"
