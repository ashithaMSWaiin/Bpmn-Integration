...
jest.mock('../../../../libs/state-management/organization-tree/organization-tree-slice.ts', () => ({
  fetchOrganizationTrees : jest.fn(),
  addOrganizationUnit : jest.fn(),
  editOrganizationUnit : jest.fn(),
  deleteOrganizationUnit : jest.fn(),
  fetchMemberOrganizationTrees : jest.fn(),
  deleteMemberOrganizationUnit : jest.fn(),
  editMemberOrganizationUnit : jest.fn(),
  FetchUsersOrganizationUnit : jest.fn(),
  GetOrganizationUnitsAvailableUsers : jest.fn(),
  fetchRolesOrganizationTrees : jest.fn(),
  deleteRolesOrganizationUnit :jest.fn(),
  GetOrganizationUnitsAvailableRoles : jest.fn(),
}));
