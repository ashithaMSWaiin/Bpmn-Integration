...
import RdsCompDataTable from "../../../../../bpmn-integration-components/src/rds-comp-data-table";
import {
  RdsCompAlertPopup,
  RdsCompFileUploader,
} from "../../../rds-components";
import RdsCompFileManagementTree from "../../../../../bpmn-integration-components/src/rds-comp-fileManagement-Tree/rds-comp-fileManagement-Tree";
import {
  RdsAlert,
  RdsButton,
  RdsIcon,
...
import RdsCompFileMover from "../../../../../bpmn-integration-components/src/rds-comp-file-mover";
...
const FileManagement = () => {
      ...
      dispatch(postFileDescriptorUploadRequest(body) as any).then(
        async (res: any) => {
          if (res.type.includes("rejected")) {
            ...
            // Update the table data here, inside the async operation
            setTableData((prevTableData) => [...prevTableData, e]);
          }
  ...
  const onSortHandler = (col: any, key: string) => {
    console.log("File Management data-table -", col, key);
  ...
  return (
    <div>
      <div className="container-fluid p-0 m-0">
        <div className="row">
          <div className="col-lg-auto offset-lg-4" style={{position:"absolute", zIndex:"9999"}}>
            {Alert.show && (
              <RdsAlert
        ...
        <div className="row">
          <div className="col-xxl-5 col-xl-5 col-lg-12 col-12 mb-xxl-0 mb-xl-0 mb-lg-4 mb-4">
            <div>
              <div className="card card-full-stretch rounded-0 border-0 px-4 py-4">
          ...
          <div className="col-xxl-7 col-xl-7 col-lg-12 col-12 mb-xxl-0 mb-xl-0 mb-lg-0 mb-4 ps-lg-1 ps-xl-1 ps-xxl-1">
            <div>
              <div className="card card-full-stretch rounded-0 border-0 px-4 py-1">
                {selectedNode === "" && (
                  <>
                    <div className="card-header bg-transparent px-0 pt-0">
