...
import RdsCompRegister from "../../../../../bpmn-integration-components/src/rds-comp-register";

// Mock the necessary dependencies or functions used in the component
jest.mock("../../../../../bpmn-integration-components/src/rds-comp-register", () => ({
  __esModule: true,
...
jest.mock('../../../../libs/state-management/organization-unit/organization-unit-slice.ts', () => ({
  putOrganizationUnitsMembersRequest: jest.fn().mockImplementation(() => Promise.resolve({})),
