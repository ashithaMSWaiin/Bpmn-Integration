...
import { Options } from '../../../../../bpmn-integration-react-core/dist/build-proxy/raaghu-proxy/index';
// To view for separetly Dashboard page please uncomment the below link

export interface TenantDashboardProps { }

const TenantDashboard = (props: TenantDashboardProps) => {
    ...
    const transparency = backgroundColor === "#000" ? 0.2 : 1.0;
    ...
    return (
        ...
        <div className="dark dashboard">
            <div className="row">
                <div className="col-lg-6 col-md-12 d-cus-none">
                    <RdsWidget
