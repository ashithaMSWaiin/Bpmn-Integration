...
jest.mock('../../../../libs/state-management/poll-admin/poll-admin-slice', () => ({
  getPollRequest : jest.fn(),
  postPollRequest : jest.fn(),
  putPollRequest : jest.fn(),
  deletePollRequest : jest.fn(),
  getPollResultRequest : jest.fn(),
}));
