...
import "./App.scss";
import { authCodeService, getGrantedSideNavItems, hybridCodeService, implicitTokenService } from "../../../../bpmn-integration-react-core/src/index";
      ...
      authCodeService(
        ...
        .then((res: any) => {
          ...
          if (res.status === 200) {
            ...
            //  window.location.href = "http://localhost:8080/processmodeler"
