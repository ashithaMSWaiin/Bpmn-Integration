...
const getConfig = (): AppConfig => ({
  ...
  REACT_APP_API_URL: localStorage.getItem('REACT_APP_API_URL') || 'https://react81api.raaghu.io',
  REACT_APP_GRANT_TYPE: localStorage.getItem('REACT_APP_GRANT_TYPE') || 'authorization_code',
  REACT_APP_CLIENT_ID: localStorage.getItem('REACT_APP_CLIENT_ID') || 'abp_react_8_1_App',
  REACT_APP_SCOPE:
    localStorage.getItem('REACT_APP_SCOPE') ||
    'address openid email phone profile roles offline_access abp_react_8_1',
